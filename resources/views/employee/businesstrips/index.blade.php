...
@section('title', 'Pengajuan Perjalanan Dinas')
...
<div class="card shadow-sm">
    ...
    <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                <h4 class="mb-0">
                    Data Pengajuan Perjalanan Dinas
                </h4>

                <small class="text-muted">
                    Kelola data pengajuan perjalanan dinas pegawai
                </small>
            </div>
            ...
            <button
                ...
                data-bs-target="#createBusinessTripModal"
            >
                + Ajukan Perdin
            </button>
        ...
        @include('employee.businesstrips.create')
